    	...
    	<form  method="post">
			...
			<div class="well">
				<div class="form-group has-feedback">
					<label>Nome</label>
					<input name="txtNome" type="text" class="form-control"  placeholder="Login">
					<i class="icon-users form-control-feedback"></i>
				</div>

				<div class="form-group has-feedback">
					<label>Email</label>
					<input name="txtEmail" type="text" class="form-control" placeholder="Login">
					<i class="icon-users form-control-feedback"></i>
				</div>
				...
				<div class="row form-actions">
					...
					<div class="col-xs-6">
						<button type="submit" name="btnCadastro" value="Cadastrar"><i class="icon-menu2"></i> Acessar</button>
					</div>
